...
public class PoolPreparedStatement implements PreparedStatement {
    private PreparedStatement preparedStatement;

    public PoolPreparedStatement(PreparedStatement preparedStatement) throws SQLException{
    ...
    // the following methods are simply delegated to preparedStatement
